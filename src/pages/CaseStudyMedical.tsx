          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                {t('caseStudies.medical.challengeTitle')}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                {t('caseStudies.medical.challengeP1')}
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t('caseStudies.medical.challengeP2')}
              </p>
            </div>
            ...
            <div className="mb-12 p-8 rounded-lg bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/20">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                {t('caseStudies.medical.solutionTitle')}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                {t('caseStudies.medical.solutionP1')}
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                {t('caseStudies.medical.solutionP2')}
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t('caseStudies.medical.solutionP3')}
              </p>
            </div>
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                {t('caseStudies.medical.outcomesTitle')}
              </h2>
              <div className="space-y-4">
                {[
                  'caseStudies.medical.outcome1',
                  'caseStudies.medical.outcome2',
                  'caseStudies.medical.outcome3',
                  'caseStudies.medical.outcome4',
                  'caseStudies.medical.outcome5',
                  'caseStudies.medical.outcome6',
                  'caseStudies.medical.outcome7',
                ].map((key, index) => (
