          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                {t('caseStudies.mobile.challengeTitle')}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t('caseStudies.mobile.challenge')}
              </p>
            </div>
            ...
            <div className="mb-12 p-8 rounded-lg bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/20">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                {t('caseStudies.mobile.solutionTitle')}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t('caseStudies.mobile.solution')}
              </p>
            </div>
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-6">
                {t('caseStudies.mobile.outcomesTitle')}
              </h2>
              <div className="space-y-4">
                {[
                  'caseStudies.mobile.outcome1',
                  'caseStudies.mobile.outcome2',
                  'caseStudies.mobile.outcome3',
                  'caseStudies.mobile.outcome4',
                ].map((key, index) => (
