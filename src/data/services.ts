...
export const services: ServiceDetail[] = [
  {
    ...
    related: ["redizajn-web-stranice", "izrada-web-aplikacija", "saas-razvoj"],
    cta: "Zatražite ponudu za izradu web stranice",
  },
  {
    slug: "redizajn-web-stranice",
    ...
    related: ["izrada-web-stranica", "izrada-crm-sustava", "izrada-web-aplikacija"],
    cta: "Pošaljite postojeću web stranicu na procjenu",
  },
  {
    slug: "izrada-crm-sustava",
    ...
    related: ["izrada-web-aplikacija", "saas-razvoj", "stripe-integracije"],
    cta: "Zatražite analizu CRM projekta",
  },
  {
    slug: "izrada-web-aplikacija",
    ...
    related: ["izrada-crm-sustava", "saas-razvoj", "stripe-integracije"],
  ...
  },
  {
    ...
    related: ["saas-razvoj", "izrada-web-aplikacija", "izrada-crm-sustava"],
  ...
  },
  {
    ...
    related: ["izrada-web-aplikacija", "izrada-crm-sustava", "stripe-integracije"],
